...
def pltallotment(app):
    ...
    treeview.heading ('Plot #', text='Plot #')
    treeview.column("Area", width=80)
    treeview.heading ('Zone', text='Zone')
    treeview.column("Area", width=80)
    treeview.heading ('Area', text="Area")
    treeview.column("CNIC", width=130)
    treeview.heading ('CNIC', text="CNIC")
    treeview.column("Owner", width=140)
    treeview.heading ('Owner', text='Owner Name')
    treeview.column("Mobile", width=100)
